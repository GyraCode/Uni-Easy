       ...
       <div class="container my-2" >
        <div class="row">
            <div class="col-md-12 jumbotron-fluid">
                <div class="jumbotron bg-cover " style="background-image: url(./images/indoor-header.png);">
                  <h1 class="display-4 text-white">Hot Sale!</h1>
                    <h2 class="display-4 text-white">在家增肌系列</h2>

                    
                    <hr class="my-5 text-white">
                    <p class= "display-4 text-white">優惠倒數計時</p>
         ...
         <div class="container">
             <div class="row bg-danger">
                 <div class="col-md-12 d-flex yogahot" >
                   <div class="col-md-5" >
                    <h1 class="display-5 mt-3 text-white text-center mt-5">免器材</h1>
                    <h2 class="display-5 text-white text-center">徒手健身</h2>
                    <button type="button" class="btn btn-outline-light ">立即加入</button>
                    </div>
                    <div class="col-md-7 pt-4 yogahotsale">
                    <div class="jumbotron jumbotron-fluid " style="background-image: url(./images/gg_banner.jpg);"></div>
                      </div>
                 </div>
             </div>
         </div>
