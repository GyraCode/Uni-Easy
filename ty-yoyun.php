        ...
        <div class="container">
            <div class="row d-flex">
                <div class="ty-p2-left d-flex flex-column col-12 col-lg-6">
                    ...
                    <p>有氧運動(Aerobic exercise或
                        Cardio)，又可稱之為有氧訓練、需氧運動、帶氧運動，而在進行這類運動時，呼吸是呈現規律性的呼氣與吸氣，肌肉方面亦呈現規律性的緊張與放鬆相互交替。

                        人體在運動時會需要ATP三磷酸腺苷來提供能量，而人體預存的ATP能量只能維持15秒，則接下來的90-120秒，就必須由血糖在無氧狀態下，合成ATP來提供能量。<br>在90-120秒之後，則會由血液中的糖分、脂肪酸、胺基酸等營養分子，在有氧狀態下，合成ATP來提供熱量。因此，所謂的有氧運動，指的是持續超過90-120秒，必須由有氧代謝合成能量的運動。

                        以上是對於有氧運動比較理論式的解說。
                    </p>
                    <div class="a-a">
                    <a href="shopping_content.php">了解更多</a>
                    <a href="ty-shopping_list.php?cat_id=3&sub_cat_id=12">前往商品頁</a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="ty-sc row">
                    <figure class="snip1268 col-12 col-lg-4">
                        <div class="image">
                            <img src="商品圖/有氧商品/yoyanp0001.jpg" alt="sq-sample4" />
                            <div class="icons">
                        ...
                        <figcaption>
                            <h2>磅數阻力帶 【綠色】約50-125磅(阻力值約25-57公斤)</h2>
                    ...
                    <figure class="snip1268 col-12 col-lg-4">
                        <div class="image">
                            <img src="商品圖/有氧商品/yoyanp0002.jpg" alt="sq-sample4" />
                            <div class="icons">
                                <a href="#"><i class="ion-star"></i></a>
                                <a href="#"> <i class="ion-share"></i></a>
                                <a href="#"> <i class="ion-search"></i></a>
                    ...
                    <figure class="snip1268 col-12 col-lg-4">
                        <div class="image">
                            <img src="商品圖/有氧商品/yoyanp0005.jpg" alt="sq-sample4" />
                            <div class="icons">
                                <a href="#"><i class="ion-star"></i></a>
                                <a href="#"> <i class="ion-share"></i></a>
                                <a href="#"> <i class="ion-search"></i></a>
