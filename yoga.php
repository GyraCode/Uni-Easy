...
<div class="container my-2">
    <div class="row">
        <div class="col-md-12 jumbotron-fluid">
            <div class="jumbotron bg-cover " style="background-image: url(./img/mother-daughter.jpg);">
                <h1 class="display-4 text-white">特別企劃!</h1>
                <h2 class="display-4 text-white">親子一起做瑜珈</h2>
        ...
        <div class="row bg-danger">
            <div class="col-md-12 d-flex yogahot">
                <div class="col-md-5">
                    ...
                    <h2 class="display-5 text-white text-center">伸展瑜珈</h2>
                    <button type="button" class="btn btn-outline-light ">立即加入</button>
                </div>
                <div class="col-md-7 pt-4 yogahotsale">
                    <div class="jumbotron jumbotron-fluid " style="background-image: url(./img/asian-muslim-fitne.jpg);"></div>
                </div>
            </div>
        </div>
    </div>
