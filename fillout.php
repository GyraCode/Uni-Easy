        ...
        <div class="row">
            ...
            <div class="col-6 px-5">
                ...
                <div class="row my-2">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" name="recipient_email" id="quick_e">
                    </div>
                </div>
                <div class="row my-2">
                    <label for="colFormLabel" class="col-sm-2 col-form-label">收件人姓名</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="recipient_name" id="quick_n">
                    </div>
                </div>
                <div class="row my-2">
                    <label for="colFormLabel" class="col-sm-2 col-form-label">手機號碼</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="recipient_phone_number" id="quick_p">
                    </div>
                </div>
                <div class="row my-2">
                    <label for="colFormLabel" class="col-sm-2 col-form-label">收件地址</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="recipient_address" id="quick_a">
                    </div>
                </div>
                <div class="row my-2">
