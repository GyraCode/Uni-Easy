        ...
        <div class="container">
            <div class="row d-flex">
                <div class="ty-p2-left d-flex flex-column col-12 col-lg-6">
                    ...
                    <h1>瑜珈商品</h1>
                    <h2>Yoga goods</h2>
                    <p>瑜珈，以舒緩壓力和讓人放鬆的功能，區隔出特性，例如：冥想、伸展，可以控制壓力的有效方法。而多項研究表示，瑜珈可以減少皮質醇的分泌。
                        ...
                        身體發炎是一種正常的免疫反應，但慢性炎症可能導致促其他疾病的發生，如：心血管疾病、糖尿病、阿茲海默症和癌症…等。
                    </p>
                    <div class="a-a">
            ...
            <div class="container">
                ...
                <div class="ty-sc row">
                    <figure class="snip1268 col-12 col-lg-4">
                        <div class="image">
                            <img src="商品圖/瑜珈商品/yogap0001.jpg" alt="sq-sample4" />
                            <div class="icons">
                    ...
                    <figure class="snip1268 col-12 col-lg-4">
                        <div class="image">
                            <img src="商品圖/瑜珈商品/yogap0002.jpg" alt="sq-sample4" />
                            <div class="icons">
                                <a href="#"><i class="ion-star"></i></a>
                                <a href="#"> <i class="ion-share"></i></a>
                                <a href="#"> <i class="ion-search"></i></a>
                    ...
                    <figure class="snip1268 col-12 col-lg-4">
                        <div class="image">
                            <img src="商品圖/瑜珈商品/yogap0003.jpg" alt="sq-sample4" />
                            <div class="icons">
                                <a href="#"><i class="ion-star"></i></a>
                                <a href="#"> <i class="ion-share"></i></a>
                                <a href="#"> <i class="ion-search"></i></a>
                        ...
                        <figcaption>
                            <h2>環保材質瑜珈墊(5mm) KIMJALY Club</h2>
